...
export default class Home extends React.Component {
    ...
    osmandDowloadAlert = (url) => Alert.alert(
        'Baixe o OsmAnd',
        'Para navegar no mapa é necessário instalar o aplicativo OsmAnd',
        [
            {
                text: 'Instalar',
    ...
    navigate = async () => {
        ...
        if (Platform.OS === 'android') {
            AppInstalledChecker.isAppInstalledAndroid('net.osmand').then((isInstalled) => {
                if (isInstalled) {
                    ...
                    this.osmandDowloadAlert(AppConfig.playStoreAppUrl);
                }
            });
        }
        if (Platform.OS === 'ios') {
            ...
            if (supported) {
                ...
                this.osmandDowloadAlert(AppConfig.appleStoreAppUrl);
            }
        }
    };
            ...
            <View style={{flex: 1}}>
                ...
                <View style={styles.centerIcon} activeOpacity={address ? 0.5 : 1}>
                    ...
                    <TouchableOpacity onPress={() => this.navigate()}>
                        ...
                        <Text style={styles.bottomLable}>Iniciar</Text>
                    </TouchableOpacity>
                </View>
